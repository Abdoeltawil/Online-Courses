 ...
 * @author Mariam
 */
public class filescontent extends javax.swing.JFrame {

    /**
     * Creates new form filescontent
     */
    
    String s ="" ;
     User user ;
     
    public filescontent(User user) throws FileNotFoundException {
        initComponents();
         this.user=user;
        File file = new File("filescontent.txt");
...
//            java.util.logging.Logger.getLogger(filescontent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new filescontent().setVisible(true);
//            }
//        });
    }
