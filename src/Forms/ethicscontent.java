 ...
 * @author Mariam
 */
public class ethicscontent extends javax.swing.JFrame {

    /**
     * Creates new form ethicscontent
     */
      String s ="" ;
     User user ;
    public ethicscontent() throws FileNotFoundException {
        initComponents();
         this.user=user;
        File file = new File("ethicscontent.txt");
...
//            java.util.logging.Logger.getLogger(ethicscontent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ethicscontent().setVisible(true);
//            }
//        });
    }
