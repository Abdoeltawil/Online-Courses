 ...
 * @author Mariam
 */
public class mathcontent extends javax.swing.JFrame {

    /**
     * Creates new form mathcontent
     */
    String s ="" ;
     User user ;
    public mathcontent() throws FileNotFoundException {
        initComponents();
         this.user=user;
        File file = new File("mathcontent.txt");
...
//            java.util.logging.Logger.getLogger(mathcontent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new mathcontent().setVisible(true);
//            }
//        });
    }
