 ...
 * @author Mariam
 */
public class statcontent extends javax.swing.JFrame {

    /**
     * Creates new form statcontent
     */
    String s ="" ;
     User user ;
    public statcontent() throws FileNotFoundException {
        initComponents();
         this.user=user;
        File file = new File("statcontent.txt");
...
//            java.util.logging.Logger.getLogger(statcontent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new statcontent().setVisible(true);
//            }
//        });
    }
